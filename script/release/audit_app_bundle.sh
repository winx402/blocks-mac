...
forbid_path "$contents/MacOS/blocksHelper"

if [[ "$channel" == "direct-beta" || "$channel" == "direct-stable" ]]; then
  embedded_helper="$contents/Helpers/blocksHelper.app"
  embedded_helper_executable="$embedded_helper/Contents/MacOS/blocksHelper"
