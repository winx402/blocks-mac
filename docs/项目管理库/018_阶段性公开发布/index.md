...
状态：0.1.0-beta.9 已签名、公证并公开发布；部分原场景验收待复验
最后更新：2026-09-20
负责人：项目负责人

## 当前工作（2026-09-20）

[Beta 9](https://github.com/winx402/blocks-mac/releases/tag/v0.1.0-beta.9)（build9）提供仅源码版的认证升级编排与取消恢复修正，已签名、公证、公开下载校验并更新在线Beta源。本机2112通过/17跳过/0失败；旧版首次迁移与真实跨版本验收边界见 [Issue #57 与 Beta 9](Issue-57与Beta9-2026-09-20.md)。

## 此前发布：Beta 8（2026-09-20）

[Beta 8](https://github.com/winx402/blocks-mac/releases/tag/v0.1.0-beta.8)（build8）包含 #50–#56 的安全生命周期、拖动、Helper名称/图标、保留保护与标签配色补丁，已签名、公证并更新Beta源。#54/#55/#56关闭，部分旧故障与原环境仍待验证；见 [按序处理与Beta 8记录](Issues-50-56与Beta8-2026-09-20.md)。

## 此前发布：Beta 7（2026-09-19）

[Beta 7](https://github.com/winx402/blocks-mac/releases/tag/v0.1.0-beta.7)（build7）新增交互日志和诊断导出，已签名、公证并更新Beta源。用法、测试及CI边界见 [Beta 7 日志增强发布](Beta7日志增强发布-2026-09-19.md)。

## 此前发布：Beta 6（2026-09-19）

[Beta 6](https://github.com/winx402/blocks-mac/releases/tag/v0.1.0-beta.6)（build6）包含收藏/关闭/默认详情入口与筛选交互补丁，24项定向测试及隔离UI检查通过，签名、公证、公开下载和Beta源已核验。#48/#49 原场景未完整复现，保留开放；详见 [Issues #48/#49 与 Beta 6](Issues-48-49与Beta6-2026-09-19.md)。

## 此前发布：Beta 5（2026-09-18）

[Beta 5](https://github.com/winx402/blocks-mac/releases/tag/v0.1.0-beta.5)（build5）增加四模块CLI授权、动态动作列表及命令自动管理，已签名、公证、公开下载复核并更新Beta源，源提交的云端CI通过。官方沙盒首次目录授权/跨版本更新的完整实机闭环仍待验收，见 [Issue #47 与 Beta 5](Issue-47与Beta5-2026-09-18.md)。

## 此前发布：Beta 4（2026-09-18）
...
[Beta 2](https://github.com/winx402/blocks-mac/releases/tag/v0.1.0-beta.2)（build 2）已完成 Developer ID 签名、公证、Gatekeeper 及下载校验，Beta appcast 已更新。本轮修复新报的权限、钥匙串、助手恢复、剪贴板屏幕选择与翻译输入问题，证据与未验证项见 [Issues #34–#42](Issues-34-42权限与交互-2026-09-17.md)。下方 9 月 6 日及更早内容为当时的历史快照，不表示当前发行仍被阻塞。
